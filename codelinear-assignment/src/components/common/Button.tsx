...
const baseClasses =
  "inline-flex items-center justify-center rounded-[4px] px-7 py-2 text-[10px] font-semibold uppercase tracking-[0.08em] transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white";
