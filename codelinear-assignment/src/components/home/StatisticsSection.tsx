      ...
      <div className="mx-auto max-w-4xl px-5 sm:px-8">
        <div className="grid gap-6 lg:grid-cols-[0.9fr_1.4fr]">
          <div>
            ...
            <button className="mt-8 rounded border border-white/30 px-8 py-2 text-xs uppercase tracking-wide text-white">
              Read all
            </button>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {insightCards.map((card, index) => (
              ...
              >
                ...
                <button className="mt-5 w-full rounded border border-white/20 py-2 text-[10px] uppercase tracking-wide text-white/80">
                  View more
                </button>
              </article>
            ))}
        ...
        <div className="relative mx-auto mt-10 max-w-2xl">
          ...
          <article className="relative grid overflow-hidden rounded bg-[#031927] shadow-2xl sm:grid-cols-[220px_1fr]">
            ...
            <div className="p-6 text-left">
              <p className="text-xs uppercase tracking-wide text-[#00A6FF]">Getting Started</p>
              ...
              <button className="mt-6 w-full rounded border border-white/20 py-2 text-[10px] uppercase tracking-wide text-white/80">
                View more
              </button>
            </div>
          </article>
          ...
          <button className="absolute bottom-0 right-0 text-[10px] uppercase tracking-wide text-[#00A6FF]">
            See all
          </button>
        </div>
      </div>
