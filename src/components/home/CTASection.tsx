      ...
      <div className="mx-auto max-w-4xl px-5 sm:px-8">
        <div className="grid items-center gap-8 sm:grid-cols-[1fr_auto]">
          ...
          <div className="flex gap-4">
            <button className="rounded border border-white/30 px-10 py-2 text-[10px] uppercase tracking-normal text-white transition hover:border-white/50 hover:bg-white/10">
              Contact us
            </button>
            <button className="rounded bg-[#005BFF] px-10 py-2 text-[10px] uppercase tracking-normal text-white transition hover:bg-[#0878FF]">
              Request demo
            </button>
          </div>
        </div>
