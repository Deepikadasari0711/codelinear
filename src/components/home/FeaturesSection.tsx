...
const FeaturesSection = () => {
  return (
    <section className="bg-[#EEF3F7] py-[72px] sm:py-24">
      <div className="mx-auto max-w-[1200px] px-5 sm:px-6 lg:px-10">
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_320px_1fr]">
          <div>
            <p className="mb-4 text-xs font-semibold uppercase tracking-normal text-[#0878FF]">
              Digital banking
            </p>
            <h2 className="text-[36px] font-medium leading-tight tracking-normal text-[#06131B] sm:text-5xl">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <button className="rounded-full bg-[#0878FF] px-6 py-3 text-sm font-semibold uppercase tracking-normal text-white transition hover:bg-[#0068df]">
                REQUEST DEMO
              </button>

              <button className="text-sm font-semibold uppercase tracking-normal text-[#0878FF] transition hover:text-[#005BC7]">
                LEARN MORE -&gt;
              </button>
            </div>
          </div>
        ...
        <div className="mt-20 grid items-center gap-12 lg:mt-32 lg:grid-cols-2">
          <div>
            <h3 className="text-[30px] font-medium tracking-normal text-[#06131B] sm:text-[40px]">
